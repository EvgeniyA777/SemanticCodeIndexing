...
1. Build the remaining closed-loop automation on top of `scheduled-governance-cycle` and `governance-history-report`, especially more opinionated promotion governance beyond the current history-aware ranking plus streak/cooldown controls.
