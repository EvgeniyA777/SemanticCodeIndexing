...
- Active execution backlog is now tracked in `docs/post-roadmap-semantic-deepening-plan.md`; Stages 1-4 (Clojure lexical/destructuring, Clojure dispatch/protocol, Java inheritance/method-reference, and Python decorator/class-scope deepening) are delivered and Stage 5 is the active slice.
